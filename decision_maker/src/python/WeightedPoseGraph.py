...
class WeightedPoseGraph:
    def __init__(self, nodes: list = None, edges: list = None, criteria: str = 'd_opt', node:Node = None):
        """
        Constructor
        ...
        """
        self.node = node
        # self.th_plan_points = self.node.get_parameter('~hallucinated_plan_th', 50)
        self.th_plan_points = 50
